...
class EndpointSerializer(serializers.ModelSerializer):
    class Meta:
        model = Endpoint
        read_only_fileds = ("id", "name", "owner", "created_at")
...
class MLAlgorithmSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MLAlgorithm
        read_only_fileds = ("id", "name", "description", "code", "version", "owner",
