...
def convolutional(input_layer, filters_shape, downsample=False, activate=True, bn=True):
    ...
    conv = Conv2D(filters=filters_shape[-1], kernal_size=filters_shape[0], strides=strides, padding=padding, use_bias=not bn, kernel_regularizer=l2(0.0005),
                  kernel_initializer=tf.random_normal_initializer(stddev=0.01), bias_initializer=tf.constant_initializer(0.))(input_layer)
...
def decode(conv_output, NUM_CLASS, i=0):
    # where i = 0, 1, or 2 to correspoond to the three grid scales
    ...
    # next need Draw the grid, where output_size equals to 13, 26, or 52
    ...
    # calculate w and h of the prediction box
