...
def extract_image_patch(image, bbox, patch_shape):
    ...
    # convert to top lefe and bottom right
    bbox[2:] += bbox[:2]
...
def create_box_encoder(model_filename, input_name="images", output_name="features", batch_size=32):
    ...
    def encoder(image, boxes):
        ...
        for box in boxes:
            ...
            if patch is None:
                print("WARING: Failed to extract image patch: %s." % str(box))
...
def parse_args():
    ...
    parser.add_argument("--detection_dir", help="Path to custom detections. Defaults to "
