...
class SpeechRecognition(nn.Module):
    ...
    def __init(self, hidden_size, num_clases, n_feats, num_layers, dropout):
        ...
        self.final_fc = nn.Linear(hidden_size, num_clases)
    
    def __init_hidden(self, batch_size):
        n, hs = self.num_layers, self.hidden_size
        
        return (torch.zeors(n*1, batch_size, hs), torch.zeros(n*1, batch_size, hs))
